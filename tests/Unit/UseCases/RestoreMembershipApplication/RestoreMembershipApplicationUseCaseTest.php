...
class RestoreMembershipApplicationUseCaseTest extends TestCase {
	...
	public function testOnRestoreMembershipApplication_removesCancelledStatus(): void {
		...
		$this->assertNotNull( $this->applicationRepository->getUnScrubbedAndUnexportedMembershipApplicationById( 1 ) );
		$this->assertFalse( $this->applicationRepository->getUnScrubbedAndUnexportedMembershipApplicationById( 1 )->isCancelled() );
	}
	...
	public function testOnRestoreMembershipApplication_andPaymentIsNotCompleted_membershipISNotConfirmed(): void {
		...
		$this->assertNotNull( $this->applicationRepository->getUnScrubbedAndUnexportedMembershipApplicationById( 1 ) );
		$this->assertFalse( $this->applicationRepository->getUnScrubbedAndUnexportedMembershipApplicationById( 1 )->isConfirmed() );
	}
	...
	public function testOnRestoreMembershipApplication_andPaymentIsCompleted_confirmsMembership(): void {
		...
		$this->assertNotNull( $this->applicationRepository->getUnScrubbedAndUnexportedMembershipApplicationById( 1 ) );
		$this->assertTrue( $this->applicationRepository->getUnScrubbedAndUnexportedMembershipApplicationById( 1 )->isConfirmed() );
	}
