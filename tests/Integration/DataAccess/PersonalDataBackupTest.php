...
class PersonalDataBackupTest extends TestCase {
	...
	private function givenMemberships( EntityManager $entityManager ): void {
		...
		$entityManager->persist( ValidMembershipApplication::newBackUppedButUnexportedDoctrineEntity( 10, new \DateTime( '2025-03-03 0:00:00' ) ) );
		$entityManager->persist( ValidMembershipApplication::newBackUppedButUnexportedDoctrineEntity( 11, new \DateTime() ) );
