...
class ApplyForMembershipUseCaseTest extends TestCase {
	...
	public function testGivenValidRequest_applicationGetsPersisted(): void {
		...
		$application = $repository->getUnScrubbedAndUnexportedMembershipApplicationById( $expectedApplication->getId() );
	...
	public function testGivenDonationReceiptOptOutRequest_applicationHoldsThisValue(): void {
		...
		$application = $repository->getUnScrubbedAndUnexportedMembershipApplicationById( self::MEMBERSHIP_APPLICATION_ID );
		$this->assertNotNull( $application );
